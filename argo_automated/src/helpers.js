...
export function getMetersInLongitudeDegree(latitude) {
  return Math.cos((latitude * Math.PI) / 180) * METERS_IN_A_LATITUDE_DEGREE;
}

export function getStep(searchRadiusInMeters, metersInDegree) {
...
export function getGrid(latRange, longRange, searchRadiusInMeters) {
